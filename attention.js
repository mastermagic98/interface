(function () {
    ...
    // Функція для створення тексту підказки з іконкою
    function createHintText(hintText, id) {
        return `
            <div id="${id}" style="overflow: hidden; display: flex; align-items: center; background-color: rgba(0, 0, 0, 0.07); border-radius: 0.5em; margin-left: 1.2em; margin-right: 1.2em; padding: 0.8em; font-size: 1.2em; transition: opacity 0.5s; line-height: 1.4;">
    ...
    // Функція для створення тексту підказки для картки з іконкою
    function createHintText_incard(hintText, id) {
        return `
            <div id="${id}" style="overflow: hidden; display: flex; align-items: center; background-color: rgba(0, 0, 0, 0.15); border-radius: 0.5em; margin-bottom: 1.2em; padding: 0.8em; font-size: 1.2em; transition: opacity 0.5s; line-height: 1.4;">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 14 14" fill="#000000" style="margin-right: 10px;">
                    <g fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M7.89 1.05a1 1 0 0 0-1.78 0l-5.5 11a1 1 0 0 0 .89 1.45h11a1 1 0 0 0 .89-1.45zM7 5v3.25"/>
                        <path d="M7 11a.25.25 0 1 1 0-.5m0 .5a.25.25 0 1 0 0-.5"/>
    ...
    function fadeOutAndRemove($el, duration) {
        ...
        // Подожди чуть дольше, чем сама анимация
        setTimeout(function () {
            $el.remove();
