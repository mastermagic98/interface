...
(function () {  
    ...
    Lampa.SettingsApi.addParam({    
        ...
        field: {    
            name: '<div style="display: flex; align-items: center;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style="margin-right:10px;flex-shrink:0;min-width:24px;min-height:24px;max-width:24px;max-height:24px" viewBox="0 0 24 24"  fill="none"><path d="M11.955 2.001c.32-.017.62.147.78.429h.002l9.908 17.374c.34.599-.055 1.29-.737 1.29H2.092c-.682 0-1.078-.691-.737-1.29L11.263 2.43h.002a.84.84 0 0 1 .69-.429z" stroke="currentColor" stroke-linecap="square" stroke-linejoin="round" stroke-width="2"/><path d="M12 18a1 1 0 1 0 0-2 1 1 0 0 0 0 2" fill="currentColor"/><path d="M12 15V8" stroke="currentColor" stroke-width="2"/></svg>' + Lampa.Lang.translate('attention_enabled') + '</div>',    
