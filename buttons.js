(function() {
    ...
    // Функція перекладу з fallback на ключ (щоб уникнути помилок)
    function t(key) {
    ...
    // Реєстрація перекладів з точними ключами, які використовує Lampa
    Lampa.Lang.add({
    ...
    // Додаємо параметр в налаштування тільки якщо API доступний
