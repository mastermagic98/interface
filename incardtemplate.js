(function () {
    ...
    // === ФІНАЛЬНИЙ ШАБЛОН — БЕЗ hide, БЕЗ overflow, БЕЗ z-index конфліктів ===
    var finalTemplate = [
        '<div class="full-start-new">',
            '<div class="full-start-new__body">',
                ...
                '<div class="full-start-new__right">',
                    ...
                    // Рейтинги — IMDb, KP, PG, Status — ВСІ ВИДНО
                    ...
                    // === КНОПКИ — ВСІ В РЯДКУ, БЕЗ hide, БЕЗ overflow, з min-width ===
                    '<div class="full-start-new__buttons" style="display:flex;flex-wrap:nowrap;gap:12px;overflow:visible;white-space:nowrap;padding:10px 0;align-items:center;">',
                    '<style>',
                        '.full-start-new__buttons > div { flex: 0 0 auto; min-width: 70px; }',
                        '.full-start-new__buttons .full-start__button { pointer-events: auto !important; }',
                    ...
                    '</style>',
                        ...
                        // 7. НАЛАШТУВАННЯ — З ОРИГІНАЛЬНИМИ КЛАСАМИ
    ...
    function applyTemplate() {
        ...
        // Додаємо глобальний CSS
        setTimeout(function () {
            var styleId = 'incard-buttons-global-fix';
            if (!document.getElementById(styleId)) {
                var style = document.createElement('style');
                style.id = styleId;
                style.innerHTML = [
                    '.full-start-new__buttons { min-height: 70px; padding: 0 10px; margin: 0 -10px; }',
                    '.full-start-new__buttons > div { margin: 0 6px; }',
                    '.full-start-new__buttons > div:first-child { margin-left: 0; }',
                    '.full-start-new__buttons > div:last-child { margin-right: 0; }',
                    '.full-start__button { position: relative; }'
                ].join('');
