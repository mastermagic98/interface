(function () {  
    ...
    Lampa.SettingsApi.addParam({  
        ...
        field: {  
            name: '<div style="display: flex; align-items: center;"><svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="32" height="32"><path d="M11.85 14.775H3.688c-1.35 0-2.438-1.1-2.438-2.438V4.175c0-1.35 1.1-2.438 2.438-2.438h8.162c1.35 0 2.438 1.1 2.438 2.438v8.162c.013 1.35-1.087 2.438-2.438 2.438M3.688 3.125c-.575 0-1.05.475-1.05 1.05v8.162c0 .575.475 1.05 1.05 1.05h8.162c.575 0 1.05-.475 1.05-1.05V4.175c0-.575-.475-1.05-1.05-1.05zm8.162 27.137H3.688c-1.35 0-2.438-1.1-2.438-2.438v-8.162c0-1.35 1.1-2.438 2.438-2.438h8.162c1.35 0 2.438 1.1 2.438 2.438v8.162c.013 1.337-1.087 2.438-2.438 2.438m-8.162-11.65c-.575 0-1.05.475-1.05 1.05v8.162c0 .575.475 1.05 1.05 1.05h8.162c.575 0 1.05-.475 1.05-1.05v-8.162c0-.575-.475-1.05-1.05-1.05zm14.713-13H30.75v1.863H18.4zm0 5.1H30.75v1.863H18.4zm0 9.55H30.75v1.863H18.4zm0 5.1H30.75v1.863H18.4z"/></svg>' + Lampa.Lang.translate('button_text_mode_name'),  
