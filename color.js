(function () {
    ...
    function createColorModal() {
        ...
        style.textContent = ':root { --main-color: #5daa68; --background-color: #1d1f20; --text-color: #ddd; --transparent-white: rgba(255,255,255,0.2); }' +
                            ...
                            // Стиль для всіх іконок, крім "Налаштування" (виключаємо .menu__ico в <li data-action="settings">)
                            '.menu__ico:not([data-action="settings"] .menu__ico), .menu__ico:not([data-action="settings"] .menu__ico) svg, .menu__ico:not([data-action="settings"] .menu__ico) path, .menu__ico:not([data-action="settings"] .menu__ico) g { background: transparent !important; color: #ddd !important; stroke: none !important; stroke-width: 0 !important; }' +
                            '.menu__ico.focus:not([data-action="settings"] .menu__ico), .menu__ico.focus:not([data-action="settings"] .menu__ico) svg, .menu__ico.focus:not([data-action="settings"] .menu__ico) path, .menu__ico.focus:not([data-action="settings"] .menu__ico) g { background: transparent !important; color: #ddd !important; stroke: none !important; stroke-width: 0 !important; }' +
