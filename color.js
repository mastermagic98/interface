        ...
        setTimeout(() => {
            ...
            if (Lampa.SettingsApi) {
                Lampa.SettingsApi.addParam({
                    ...
                    field: { name: '<div style="display: flex; align-items: center;"><svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M1.566 3.22C3.899-.042 8.733-.991 12.174 1.255c3.397 2.217 4.646 6.482 3.254 10.483-1.314 3.778-4.775 5.274-7.27 3.374-.934-.712-1.297-1.605-1.472-3.054l-.084-.823-.036-.332c-.097-.778-.246-1.127-.56-1.31-.424-.248-.707-.254-1.265-.027l-.279.121-.142.065c-.805.367-1.34.496-2.017.347l-.159-.04-.13-.038c-2.213-.72-2.541-3.874-.448-6.8m.78 5.599.099.03.106.025c.348.073.646.013 1.14-.201l.478-.214c.954-.411 1.576-.45 2.418.041.728.427 1.012 1.082 1.157 2.217l.042.383.043.443.038.352c.136 1.134.385 1.742.99 2.204 1.806 1.375 4.393.257 5.453-2.792 1.204-3.46.138-7.096-2.765-8.992C8.628.41 4.48 1.226 2.518 3.97c-1.647 2.303-1.445 4.4-.171 4.848m8.91-1.662a.992 1.042 0 1 1 1.917-.54.992 1.042 0 0 1-1.916.54m.393 2.907a.992 1.042 0 1 1 1.917-.54.992 1.042 0 0 1-1.917.54m-1.962-5.41a.992 1.042 0 1 1 1.917-.54.992 1.042 0 0 1-1.917.54m-.023 7.5a.992 1.042 0 1 1 1.917-.54.992 1.042 0 0 1-1.917.54M6.89 3.843a.992 1.042 0 1 1 1.917-.539.992 1.042 0 0 1-1.917.539"/></svg>' + Lampa.Lang.translate('color_plugin_enabled') + '</div>', description: Lampa.Lang.translate('color_plugin_enabled_description') },
                    onChange: value => {
                        ColorPlugin.settings.enabled = value === 'true';
                        Lampa.Storage.set('color_plugin_enabled', value.toString());
                        localStorage.setItem('color_plugin_enabled', value.toString());
                        applyStyles();
                        forceBlackFilterBackground();
                        updateCanvasFillStyle(window.draw_context);
