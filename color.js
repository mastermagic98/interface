(function () {
    ...
    function createColorModal() {
        ...
        style.textContent = ':root { --main-color: #5daa68; --background-color: #1d1f20; --text-color: #ddd; --transparent-white: rgba(255,255,255,0.2); }' +
                            ...
                            '.menu__ico:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings), .menu__ico:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings) svg, .menu__ico:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings) path, .menu__ico:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings) g { background: transparent !important; color: #ddd !important; stroke: none !important; stroke-width: 0 !important; }' +
                            '.menu__ico.focus:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings), .menu__ico.focus:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings) svg, .menu__ico.focus:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings) path, .menu__ico.focus:not([class*="setting"]):not(.menu__ico-settings):not(.menu__ico__settings) g { background: transparent !important; color: #ddd !important; stroke: none !important; stroke-width: 0 !important; }' +
