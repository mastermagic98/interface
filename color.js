        ...
        setTimeout(function() {
            ...
            if (Lampa.SettingsApi) {
                Lampa.SettingsApi.addComponent({
                    ...
                    icon: '<svg width="24px" height="24px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#ffffff"><path fill-rule="evenodd"...
                });

                // ... (весь код addParam залишається без змін)
