(function () {
    ...
    function createColorModal() {
        ...
        style.textContent = ':root { --main-color: #5daa68; --background-color: #1d1f20; --text-color: #fff; --transparent-white: rgba(255,255,255,0.2); }' +
                            ...
                            '.menu__ico, .menu__ico svg, .menu__ico path, .menu__ico g { background: transparent !important; color: var(--text-color) !important; fill: var(--text-color) !important; stroke: var(--text-color) !important; -webkit-filter: none !important; filter: none !important; }' +
                            '.menu__ico.focus, .menu__ico.focus svg, .menu__ico.focus path, .menu__ico.focus g { background: transparent !important; color: var(--text-color) !important; fill: var(--text-color) !important; stroke: var(--text-color) !important; -webkit-filter: none !important; filter: none !important; }' +
                            '.menu__ico--person::before, .menu__ico--person::after { content: none !important; }' +
                            '.menu__ico--person svg, .menu__ico--person path, .menu__ico--person g { stroke-width: 0 !important; stroke: none !important; fill: var(--text-color) !important; }' +
                            ...
                            '.console__tab.focus, .menu__item.focus, .menu__item.traverse, .menu__item.hover, .full-person.focus, .full-start__button.focus, .full-descr__tag.focus, .simple-button.focus, .head__action.focus, .head__action.hover, .player-panel .button.focus, .search-source.active { background: var(--main-color) !important; color: var(--text-color) !important; }' +
        ...
        Lampa.Storage.listener.follow('change', function (e) {
            ...
            if (e.name === 'selectedTheme') {
                setTimeout(function () {
                    ...
                    style.textContent = '.menu__ico, .menu__ico svg, .menu__ico path, .menu__ico g { background: transparent !important; color: var(--text-color) !important; fill: var(--text-color) !important; stroke: var(--text-color) !important; -webkit-filter: none !important; filter: none !important; }' +
                                        '.menu__ico.focus, .menu__ico.focus svg, .menu__ico.focus path, .menu__ico.focus g { background: transparent !important; color: var(--text-color) !important; fill: var(--text-color) !important; stroke: var(--text-color) !important; -webkit-filter: none !important; filter: none !important; }' +
                                        '.menu__ico--person::before, .menu__ico--person::after { content: none !important; }' +
                                        '.menu__ico--person svg, .menu__ico--person path, .menu__ico--person g { stroke-width: 0 !important; stroke: none !important; fill: var(--text-color) !important; }' +
                                        '.card.selector.focus .card__title, .card.selector:hover .card__title, .card .card__title { background: transparent !important; color: var(--text-color) !important; }' +
                                        '.menu__item.focus, .menu__item.traverse, .menu__item.hover { background: var(--main-color) !important; color: var(--text-color) !important; }';
                    document.head.appendChild(style);
                }, 0);
            }
        });
