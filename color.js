    ...
    setTimeout(function() {  
        ...
        if (Lampa.SettingsApi) {  
            ...
            Lampa.SettingsApi.addParam({  
                ...
                onChange: function(value) {  
                    ColorPlugin.settings.highlight_enabled = value;  
            ...
            Lampa.SettingsApi.addParam({  
                ...
                onChange: function(value) {  
                    ColorPlugin.settings.dimming_enabled = value;  
