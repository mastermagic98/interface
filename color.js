(function () {
    ...
    function createColorModal() {
        ...
        style.textContent = ':root { --main-color: #5daa68; --background-color: #1d1f20; --text-color: #ddd; --transparent-white: rgba(255,255,255,0.2); }' +
                            ...
                            '.menu__ico:not([class*="settings"]):not(.menu__ico-settings), .menu__ico:not([class*="settings"]):not(.menu__ico-settings) svg, .menu__ico:not([class*="settings"]):not(.menu__ico-settings) path, .menu__ico:not([class*="settings"]):not(.menu__ico-settings) g { background: transparent !important; color: #ddd !important; stroke: none !important; stroke-width: 0 !important; }' +
                            '.menu__ico.focus:not([class*="settings"]):not(.menu__ico-settings), .menu__ico.focus:not([class*="settings"]):not(.menu__ico-settings) svg, .menu__ico.focus:not([class*="settings"]):not(.menu__ico-settings) path, .menu__ico.focus:not([class*="settings"]):not(.menu__ico-settings) g { background: transparent !important; color: #ddd !important; stroke: none !important; stroke-width: 0 !important; }' +
                            // Стиль для іконки "Налаштування": лише прозорий фон, без color, stroke чи stroke-width
                            '.menu__ico[class*="settings"], .menu__ico.menu__ico-settings, .menu__ico[class*="settings"] svg, .menu__ico.menu__ico-settings svg, .menu__ico[class*="settings"] path, .menu__ico.menu__ico-settings path, .menu__ico[class*="settings"] g, .menu__ico.menu__ico-settings g { background: transparent !important; }' +
                            '.menu__ico.focus[class*="settings"], .menu__ico.focus.menu__ico-settings, .menu__ico.focus[class*="settings"] svg, .menu__ico.focus.menu__ico-settings svg, .menu__ico.focus[class*="settings"] path, .menu__ico.focus.menu__ico-settings path, .menu__ico.focus[class*="settings"] g, .menu__ico.focus.menu__ico-settings g { background: transparent !important; }' +
