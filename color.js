(function () {
    ...
    const applyStyles = () => {
        ...
        style.innerHTML = [
            ...
            // Основний фокус (включаючи menu-edit-list)
    ...
    const initPlugin = () => {
        setTimeout(() => {
            ...
            if (Lampa.SettingsApi) {
                ...
                // Змінювати форму картки та рамки
                Lampa.SettingsApi.addParam({
                    component: 'interface_customization',
