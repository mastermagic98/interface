(function () {  
  ...
  function initShowTextButtons() {  
    ...
    if (typeof Lampa.Params !== 'undefined') {  
      Lampa.Params.trigger('showtextbuttons', false);  
    }  
