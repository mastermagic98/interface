(function () {
    ...
    // Переклади (резерв, якщо translations.js завантажиться пізніше)
    Lampa.Lang.add({
        color_plugin: {
            ru: 'Настройка цветов',
            en: 'Color settings',
    ...
    // Список модулів для підключення (без рамки)
    var modules = [
    ...
    // Запуск плагіну після завантаження всіх модулів
    function startPlugin() {
        ...
        // Виклик ініціалізації з init.js
