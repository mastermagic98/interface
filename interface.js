(function () {
    ...
    function startPlugin() {
        ...
        // Перевіряємо, чи компонент додався
        if (Lampa.Settings.component('accent_color_plugin')) {
            console.log('Компонент accent_color_plugin присутній у налаштуваннях');
        } else {
            console.error('Компонент accent_color_plugin не знайдено після додавання');
        }
